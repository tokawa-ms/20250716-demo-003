...
class RetroTetris {
    constructor() {
        ...
        // コロベイニキのメロディ（正確な音程）
        // E四分,B↓八部,C八部,D四分,C八部,B↓八部,
        // A↓四部,A↓八部,C八部,E四部,D八部,C八部,
        // B↓四部,B↓八部,C八部,D四部,E四部,
        // C四部,A↓四部,A↓四部,休み四部
        // 休み八部,D四部,F八部,A四部,G八部,F八部,
        // E四部,休み八部,C八部,E四部,D八部,C八部,
        // B↓四部,B↓八部,C八部,D四部,E四部
        // C四部,A↓四部,A↓二部
        ...
        // コロベイニキの正しい音符の長さ（ms）
        // 四分音符=400ms, 八分音符=200ms, 二分音符=800ms
